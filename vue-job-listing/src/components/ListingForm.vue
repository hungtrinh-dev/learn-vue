        ...
        <form @submit.prevent="handleSubmit">
          ...
          <div>
            <button
              ...
              type="submit"
            >
              <span v-if="createNewListingInProgress">Submiting...</span>
              <span>Add Job</span>
            </button>
          </div>
        </form>
...
const { handleCreateNewJobListing, createNewListingInProgress } = defineProps({
  handleCreateNewJobListing: Function,
  createNewListingInProgress: Boolean
})
...
const handleSubmit = async () => {
  ...
  handleCreateNewJobListing(newJob)
}
</script>
